...
$(function () {
    ...
    $('#update-btn').click(function () {
        let rows = getTableSelection('#ddjgbzTable');
        ...
        $('#update-sfbz').val(rows[0].data.sfbz);
    });
...
function setTable(data) {
    if ($('#ddjgbzTable').html != '') {
        $('#ddjgbzTable').bootstrapTable('load', data);
    }

    $('#ddjgbzTable').bootstrapTable({
        data: data,
        sortStable: true,
