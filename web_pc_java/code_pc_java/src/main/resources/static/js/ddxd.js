                    ...
                    $(document).ready(function() {
                        $('#fj'+row.id).change(function() {
                            ...
                            if(selectedValue=='铝型材') {
                                ...
                                this_lxc = "<option value=\"\" selected>请选择</option>" + this_lxc;
                                $("#gh" + row.id).append("<option selected>" + this_lxc + "</option>");
                                for (var i = 0; i < r; i++) {
                                ...
                                this_dy = "<option value=\"\" selected>请选择</option>" + this_dy;
                                $("#gh"+row.id).append("<option>" + this_dy+ "</option>")
                                return select5;
                            }else if(selectedValue=='开关'){
                                $("#gh"+row.id).show();
                                ...
                                this_kg = "<option value=\"\" selected>请选择</option>" + this_kg;
                                $("#gh"+row.id).append("<option>" + this_kg + "</option>")
                                // return select6;
                            }else if(selectedValue == '配件'){
                                $("#gh"+row.id).show();
                                ...
                                var this_pj = ""
                                var select7 = ""
                                for (var i = 0; i < select_pj.length; i++) {
                                    this_pj = this_pj + "<option value=\"" + select_pj[i].pj + "\" >" + select_pj[i].pj + "</option>"
                                    select7 = "<select id='pj" + row.id + "' oninput='javascript:columnUpd(" + row.id + "," + "\"pj\"" + ")' placeholder='配件' type='text' class='form-control' value='" + value + "'>"
                                    select7 = select7 + this_pj;
                                    select7 = select7 + "<select/>"
                                    // $("#gh"+row.id).append("<option>" + select_pj[i].pj  + "</option>")
                                }
                                this_pj = "<option value=\"\" selected>请选择</option>" + this_pj;
                                $("#gh"+row.id).append("<option>" + this_pj + "</option>")
                                // return select7;
                            }
                        })
                    })
