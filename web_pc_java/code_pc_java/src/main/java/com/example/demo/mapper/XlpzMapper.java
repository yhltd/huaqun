...
public interface XlpzMapper extends BaseMapper<xlpz> {
    ...
    @Select("select lxc from dropdowntable where lxc != '' and lxc is not null")
    List<xlpz> hqxllxc();

    @Select("select dy from dropdowntable where dy != '' and dy is not null")
    List<xlpz> hqxlDy();

    @Select("select kg from dropdowntable where kg != '' and kg is not null")
    List<xlpz> hqxlKg();

    @Select("select pj from dropdowntable where pj != '' and pj is not null")
    List<xlpz> hqxlPj();

    @Select("select lcys from dropdowntable where lcys != '' and lcys is not null")
    List<xlpz> hqxlLcys();

    @Select("select shfs from dropdowntable where shfs != '' and shfs is not null")
    List<xlpz> hqxlShfs();

    @Select("select lxc_lk from dropdowntable where lxc_lk != '' and lcys_lk is not null")
    List<xlpz> hqxlLvxingcai();

    @Select("select lcys_lk from dropdowntable where lcys_lk != '' and lcys_lk is not null")
    List<xlpz> hqxlLvcaiYanse();

    @Select("select blsjg from dropdowntable where blsjg != '' and blsjg is not null")
    List<xlpz> hqxlBlsjg();

    @Select("select blys from dropdowntable where blys != '' and blys is not null")
    List<xlpz> hqxlBlys();

    @Select("select lsxh from dropdowntable where lsxh != '' and lsxh is not null")
    List<xlpz> hqxlLsxh();

    @Select("select kjlk from dropdowntable where kjlk != '' and kjlk is not null")
    List<xlpz> hqxlKjlk();

    @Select("select jlkw from dropdowntable where jlkw != '' and jlkw is not null")
    List<xlpz> hqxlJlkw();

    @Select("select fjpz from dropdowntable where fjpz != '' and fjpz is not null")
    List<xlpz> hqxlFjpz();

    @Select("select jlpp from dropdowntable where jlpp != '' and jlpp is not null")
    List<xlpz> hqxlJlpp();

    @Select("select gy from dropdowntable where gy != '' and gy is not null")
    List<xlpz> hqxlgy();

    @Select("select quyu from dropdowntable where quyu != '' and quyu is not null")
    List<xlpz> hqquyu();

    @Select("select kucun from dropdowntable where kucun != '' and kucun is not null")
    List<xlpz> hqkucun();

    @Select("select ghxl from dropdowntable where ghxl != '' and ghxl is not null")
    List<xlpz> ghxl();
