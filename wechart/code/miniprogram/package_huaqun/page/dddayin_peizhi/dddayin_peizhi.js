...
Page({
  ...
  save:function(){
    ...
    var sql = "update dengdai_dayin set P1='" + peizhi_dayin_body.P1 + "',P2='" + peizhi_dayin_body.P2 + "',P3='" + peizhi_dayin_body.P3 + "',P4='" + peizhi_dayin_body.P4 + "',P5='" + peizhi_dayin_body.P5 + "',P6='" + peizhi_dayin_body.P6 + "',P7='" + peizhi_dayin_body.P7 + "' where id=" + peizhi_dayin_body.id
