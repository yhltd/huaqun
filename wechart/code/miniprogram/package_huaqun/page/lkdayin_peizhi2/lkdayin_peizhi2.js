...
Page({
  ...
  onLoad(options) {
    ...
    var sql = "select * from lvkuang_dayin2"
  ...
  save:function(){
    ...
    var sql = "update dengdai_dayin set P1='" + peizhi_dayin_body.P1 + "',P2='" + peizhi_dayin_body.P2 + "',P3='" + peizhi_dayin_body.P3 + "',P4='" + peizhi_dayin_body.P4 + "',P5='" + peizhi_dayin_body.P5 + "',P6='" + peizhi_dayin_body.P6 + "',P7='" + peizhi_dayin_body.P7 + "',P8='" + peizhi_dayin_body.P8 + "',P9='" + peizhi_dayin_body.P9 + "',P10='" + peizhi_dayin_body.P10 + "',P11='" + peizhi_dayin_body.P11 + "',P12='" + peizhi_dayin_body.P12 + "',P13='" + peizhi_dayin_body.P13 + "',P14='" + peizhi_dayin_body.P14 + "',P15='" + peizhi_dayin_body.P15 + "',P16='" + peizhi_dayin_body.P16 + "',P17='" + peizhi_dayin_body.P17 + "',P18='" + peizhi_dayin_body.P18 + "',P19='" + peizhi_dayin_body.P19 + "',P20='" + peizhi_dayin_body.P20 + "',P21='" + peizhi_dayin_body.P21 + "',P22='" + peizhi_dayin_body.P22 + "',P23='" + peizhi_dayin_body.P23 + "' where id=" + peizhi_dayin_body.id
