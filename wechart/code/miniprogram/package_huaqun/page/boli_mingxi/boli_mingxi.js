...
Page({
  ...
  over_click:function(){
    var _this = this
    var sql = "update boli_xiadan set " + _this.data.this_column + "='" + _this.data.over_click + "' where id="+ _this.data.id
    console.log(sql)
    wx.cloud.callFunction({
      name: 'sqlserver_huaqun',
      data: {
